...
<div class="modal fade" id="modal-default">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{url('admin/zakatfitrah/filter')}}" method="POST" class="form-horizontal">
      	{{ csrf_field() }}
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title">Filter Zakat Fitrah</h4>
	      </div>
	      <div class="modal-body">
	      	<div class="form-group">
              <label for="inputEmail3" class="col-sm-3 control-label">Zakat Fitrah Berupa</label>
              <div class="col-sm-8">
                <select class="form-control select2" name="jeniszakat_id">
	                <option value="0">- All Data -</option>
	                <option value="1" {{(session('jeniszakat_id') == 1) ? 'selected' : ''}}>Uang Tunai</option>
	                <option value="2" {{(session('jeniszakat_id') == 2) ? 'selected' : ''}}>Beras</option>
                </select>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-3 control-label">Tanggal Zakat Fitrah</label>
              <div class="col-sm-8">
              	<input type="text" class="form-control tanggal" value="{{session('tanggalfitrah')}}" name="tanggalfitrah">
              </div>
            </div>
	      </div>
