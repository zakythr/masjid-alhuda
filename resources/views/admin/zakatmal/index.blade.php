...
<div class="modal fade" id="modal-default">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{url('admin/zakatmal/filter')}}" method="POST" class="form-horizontal">
      	{{ csrf_field() }}
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title">Filter Zakat Mal</h4>
	      </div>
	      <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-3 control-label">Tanggal Zakat Mal</label>
              <div class="col-sm-8">
              	<input type="text" class="form-control tanggal" value="{{session('tanggalmal')}}" name="tanggalmal">
              </div>
            </div>
	      </div>
	...
	$(function() {
	    table = $('#example2').DataTable({
	        ...
	        columns: [
				...
				{ data: 'tanggalmal', searchable: false, orderable: false},
