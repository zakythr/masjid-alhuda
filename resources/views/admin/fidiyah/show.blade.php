...
<div class="box">
	<div class="box-header with-border">
	  	...
	  	<div class="box-tools pull-right">
	    	<a href="{{$url}}" class="btn btn-primary"><i class="fa fa-angle-double-left"></i> Kembali</a>
	  	</div>
	</div>
	...
	<div class="box-footer">
		<div class="col-sm-8 col-sm-offset-2">
		  	<a href="{{$url}}" type="submit" class="btn btn-default">Kembali</a>
